...
You have to design & build the backend for the application and the ability for the users to register, search, submit and solve the problems.
...
https://github.com/azaylamba/geeksforgeeks 
